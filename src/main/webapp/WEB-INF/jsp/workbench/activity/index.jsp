    ...
    <script type="text/javascript">
        jQuery(function ($) {
            ...
            $("#dataBody").on("click", "a[del]", function () {
                // location = "/workbench/activity/detail.jsp?id="+$(this).attr("del");
                location = "/act/detailView?id="+$(this).attr("del");
            });
            ...
            <form class="form-inline" id="searchForm" role="form" style="position: relative;top: 8%; left: 5px;">
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input class="form-control" name="searchMap['name']" type="text" id="name">
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input class="form-control" name="searchMap['owner']" type="text" id="owner">
                    </div>
                </div>
